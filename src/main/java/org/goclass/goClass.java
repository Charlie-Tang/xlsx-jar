...
//					System.out.println(s1+" "+s3+" "+s4);
		 ...
		 WritableWorkbook book = Workbook.createWorkbook(new File("F://goClass.xls"));
		 ...
		 //插入综合注释行
		 Label label2 = new Label(1,0,"go_level2");
		 //插入go_level1_mix
	...
	public static void main(String[] args) {
		...
		File file1 = new File("F:\\20180926_F18FTSNWKF1790_I-WAbyS005_Mures_tang\\F18FTSNWKF1790_I-WAbyS005_20180926\\Submit\\BGI_result\\Function_Analyse\\DiffExpressedProtein\\GO_Enrichment\\A-VS-B_GO_enrichment\\1.xls");
